    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_alt_ua', models.CharField(max_length=255, null=True)),
            ],
            options={
                'verbose_name': 'Insta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_ua', models.CharField(max_length=255, null=True)),
                ('comment', models.TextField()),
                ('comment_en', models.TextField(null=True)),
                ('comment_ua', models.TextField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_top_text_ua', models.CharField(max_length=255, null=True)),
                ('footer_bottom_text', models.CharField(max_length=255)),
                ('footer_description', models.TextField()),
                ('footer_description_en', models.TextField(null=True)),
                ('footer_description_ua', models.TextField(null=True)),
                ...
                ('address1_ua', models.CharField(max_length=255, null=True)),
                ('address1_link', models.URLField(null=True)),
                ('address2', models.CharField(max_length=255)),
                ('address2_en', models.CharField(max_length=255, null=True)),
                ('address2_ua', models.CharField(max_length=255, null=True)),
                ...
                ('subscribe_form_text_ua', models.CharField(max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_alt_ua', models.CharField(max_length=255, null=True)),
                ('title', models.CharField(max_length=255, null=True)),
                ('title_en', models.CharField(max_length=255, null=True)),
                ('title_ua', models.CharField(max_length=255, null=True)),
