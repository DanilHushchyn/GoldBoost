...
class ProductController(ControllerBase):
    ...
    def add_product_to_cart(self, request: HttpRequest, product_id: int, body: AddToCartSchema) -> MessageOutSchema:
        """
    ...
    def get_hot_products(self, page: int, page_size: int, game_id: int = None) -> dict:
        """
    ...
    def get_tab_content(self, request: HttpRequest, tab_id: int) -> ProductTabs:
        """
    ...
    def search_products(self, request: HttpRequest, search_line: str, game_id: int = None) -> QuerySet:
        """
